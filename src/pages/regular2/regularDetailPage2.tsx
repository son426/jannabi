              ...
              <div ref={boxRef2} className="test">
                <S.Row3>
                  <div>
                    ...
                    이야기를 눈치 없이 다 담아버렸네요. ‘전설'이라는 쓸데없이
                    장엄하고 촌스럽기 그지없는 이름과 함께요. 투 머치
                    인포메이션. 그래서 빙빙 돌며 같은 말을 반복하기도 할테니 남
                    이야기 듣듯 무심히 들어주세요. 언젠가는 다 사라져 전설로
                    남을 청춘의 처절했던 시간들에 대한 이야기라며. 많은 시간
                    함께 기다려준 우리 팬분들께 감사 드립니다. 우리도 얼마나
                    많이 기다려왔는지 몰라요.
                  </div>
                </S.Row3>
              </div>
