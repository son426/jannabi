...
export const regularData = [
  ...
  },
  {
    index: 3,
    title: "Surprise!",
    description: `노래하는 에이미를 먼발치에서 바라보던\n벨보이 형제 노엘과 그레이엄.\n\n형 노엘이 동생에게 에이미와 사랑에 빠진 사실을 고백한다.`,
  },
  {
    index: 4,
    title: "Wish",
  ...
  },
  {
    index: 6,
    title: "HONG KONG",
    description: `낙천적인 원숭이들, 알렉스의 허무맹랑한\n이야기들이 오랜만에 존을 들뜨게 하였고,\n그런 자신의 모습에 놀란 존은 방으로 돌아가 생각에 잠긴다.\n\n어른들이 쉽게만 던지는 것 같았던 흔해 빠진 말들도,\n뭔 말인지 모르겠다며 집을 뛰쳐나왔던 그 자신도 하나 둘 이해하고 용서한다.\n\n그리고 아버지가 늘 흥얼대던\n촌스런 멜로디를 따라 해본다.`,
  },
  {
    index: 7,
    title: "꿈나라 별나라",
    description: `노엘이 에이미에게 사랑을 고백하는 장면.\n"Surprise!" 에서 그랬듯이 나름대로 준비한\n말들로 프로포즈를 한다.\n\n뜨거운 여름밤에 대해 노래하던 어른스러운\n에이미에게, 꿈나라가 어쩌고 별나라가 어쩌고 동요에서나 나올 법 한 말들을 횡설수설..\n\n그래도 대답은 ‘YES!!!'`,
  },
  {
    index: 8,
    title: "Jungle",
  ...
  },
  {
    index: 9,
    title: "MONKEY HOTEL\n(Finale)",
    description: `고향으로 돌아가는 존을 위한\n원숭이들의 노래.`,
  },
  {
    index: 10,
    title: "왕눈이 왈츠\n(Bonus track)",
    description: `나가던 길,\n존은 호텔 지하의 바에서부터 들려오는\n우울한 노래 소리에 귀를 기울인다.\n\n우연히 알게 된 아웃사이더 원숭이 엘리엇의 존재.\n\n존은 맘 한구석 찜찜한 마음을 담고\n호텔을 나오게 된다.\n다시 돌아올 수 있을까.`,
  },
];
